...
export default function ProductListPage() {
    ...
    const updateSearchParams = (params: { category?: string; status?: string; page?: number }) => {
        ...
        if (params.category !== undefined) {
            params.category ? newParams.set('category', params.category) : newParams.delete('category')
        }

        if (params.status !== undefined) {
            params.status ? newParams.set('status', params.status) : newParams.delete('status')
        }
